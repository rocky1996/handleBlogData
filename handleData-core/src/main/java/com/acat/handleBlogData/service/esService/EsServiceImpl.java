...
import com.acat.handleBlogData.enums.GenderEnum;
...
//            userDetailResp.setVerified(hit.getSourceAsMap().get("source_id") == null ? "未知" : Ve.getGenderEnum(Integer.parseInt(String.valueOf(hit.getSourceAsMap().get("gender")))).getDesc());
